...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Listas de campañas</li>
  </ol>
</nav>

<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
  <div>
    <h4 class="mb-3 mb-md-0">Listas de campañas Correo Electrónico</h4>
  </div>
          ...
          <table id="dataTableExample" class="table" style="width:100%">
            ...
            <tbody>
              <tr>
                ...
                <td>Gana Tanqueando en nuest...</td>
                <td>26/04/2021</td>
                <td>2.361</td>
                <th>31%</th>
                <td class="max-w-30">
